...
import { Div, Button, Field, FieldInfo, Table, Cell, CellHeader, Row, TableBody, TableHead, tooltip } from '@common/components';
...
export const FieldsEdit = ({ data, updateData } : ContentProps<TableContentModel>|ContentProps<FormContentModel>) => {
