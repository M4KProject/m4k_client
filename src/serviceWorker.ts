...
//       glb.dispatchEvent(new CustomEvent('sw-update-available'));
//     },
//     onOfflineReady() {
...
//   glb.addEventListener('sw-update-available', callback);

//   return () => {
//     glb.removeEventListener('sw-update-available', callback);
//   };
// };
