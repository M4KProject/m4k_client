...
import { page$, PageName } from '@/device/messages/page$';
import { LoadingPage } from '@/device/pages/LoadingPage';
import { MonitorSpeaker, Settings, Bug, Calendar, List, Wrench } from 'lucide-react';
import { CodePinPage } from '@/device/pages/CodePinPage';
import { ConfigPlaylistPage } from '@/device/pages/ConfigPlaylistPage';
import { TestPage } from '@/device/pages/TestPage';
import { Corners } from './Corners';
import { KioskPage } from '@/device/pages/KioskPage';
import { ActionsPage } from '@/device/pages/ActionsPage';
import { EventsPage } from '@/device/pages/EventsPage';
import { PlaylistPage } from '@/device/pages/PlaylistPage';
import { PairingPage } from '@/device/pages/PairingPage';
import { useEffect, useMemo } from 'preact/hooks';
import { offlineMode$ } from '@/device/messages';
import { DialogContainer } from './DialogContainer';
import { useFlux } from '@/hooks/useFlux';
import { Side, SideButton, SideSep } from '@/components/Side';
import { DeviceContext, DeviceCtrl, useDeviceCtrl } from '@/device/controllers/DeviceCtrl';
