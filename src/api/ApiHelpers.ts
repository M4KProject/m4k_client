...
import { isItem, isObject, isString } from "fluxio";
import { ItemOrId } from "./models";
...
export const toId = (itemOrId: ItemOrId) => isItem(itemOrId) ? itemOrId.id : isString(itemOrId) ? itemOrId : '';
