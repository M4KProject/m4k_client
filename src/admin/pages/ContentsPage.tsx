...
export const ContentsPage = () => {
    ...
    const [contents, contentsRefresh] = useAsync([], () => contentColl.find(groupId ? { group: groupId } : {}), 'contents', [groupId])
    ...
    return (
        <Page cls={c}>
            <PageHeader title="Les contenus">
                <Button title="Ajouter un contenu" icon={<MdAddToPhotos />} color="primary" onClick={handleAdd} />
                        ...
                        {filteredContents.map(c => (
                            <Row key={c.id}>
                                ...
                                <Cell>
                                    <Field
                                        value={c.title}
                                        onValue={title => handleUpdate(c, { title })}
                                    />
                                </Cell>
                                <Cell variant="around">
                                    <Button
